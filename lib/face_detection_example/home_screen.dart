...
import 'package:filterplay/face_detection_example/face_detection_painter.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> _initializeCamera(CameraDescription cameraDescription) async {
    final controller = CameraController(
      ...
      // you can set resolution according to your needs and phone system.
...
// camera is working fine, i am using emulator thats why it is showing this.